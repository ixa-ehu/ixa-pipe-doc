...
public class CLI {
  ...
  private ArgumentParser argParser = ArgumentParsers.newArgumentParser(
      "ixa-pipe-doc-" + version + "-exec.jar").description(
      "ixa-pipe-doc-" + version
  ...
  public final void classify(final InputStream inputStream,
    ...
    KAFDocument.LinguisticProcessor newLp = kaf.addLinguisticProcessor(
        "topics", "ixa-pipe-doc-" + Files.getNameWithoutExtension(model), version + "-" + commit);
  ...
  public final void server() {
    ...
    Properties serverproperties = setDocServerProperties(port, model, lang, clearFeatures, outputFormat);
  ...
  private void loadDocParameters() {
    ...
    docParser.addArgument("-m", "--model")
        .required(true)
        .help("Pass the model to do the tagging as a parameter.\n");
    docParser.addArgument("--clearFeatures")
        .required(false)
  ...
  /**
   * Set a Properties object with the CLI parameters for Document Classification.
   * @param model the model parameter
   * @param language language parameter
   * @param clearFeatures resetting the features
   * @return the properties object
   */
  private Properties setDocProperties(String model, String language, String clearFeatures) {
  ...
  private Properties setDocServerProperties(String port, String model, String language, String clearFeatures, String outputFormat) {
